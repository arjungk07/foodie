...
export default function ProductDetails() {
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-20 text-center animate-pulse">
        <p className="text-sm font-semibold text-slate-500">Loading wholesale offer details...</p>
      </div>
    );
  }
  ...
  const wholesaleDiscount = Math.round(((currentProduct.price - currentProduct.wholesalePrice) / currentProduct.price) * 100);
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-200/80 dark:border-slate-850 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4 pb-4 border-b border-slate-100 dark:border-slate-800">
              <div>
                <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">Wholesale Price (MOQ)</p>
                <p className="text-2xl font-black text-emerald-600 dark:text-emerald-500">
                  {formatINR(currentProduct.wholesalePrice)}
                  <span className="text-xs text-slate-400 font-normal"> / unit</span>
                </p>
              </div>
              <div>
                <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">Retail Sample Price</p>
                <p className="text-xl font-bold text-slate-550 line-through dark:text-slate-400">
            ...
            {/* Wholesale saving incentive banner */}
            <div className="rounded-xl bg-indigo-50/50 p-3 text-[10px] text-indigo-800 font-semibold dark:bg-indigo-950/10 dark:text-indigo-400 flex items-center justify-between">
              <span>Bulk purchase unlocks a {wholesaleDiscount}% unit discount!</span>
              <span className="bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded text-[9px] uppercase">B2B Deal</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 flex flex-col justify-end pt-5">
                ...
                >
                  ...
                  <span>Sourcing Order ({quantity} units)</span>
                </button>
              </div>
          ...
          <div className="mt-4 flex flex-col gap-4">
            <div>
              <h3 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2">Product Description</h3>
      ...
      {relatedProducts.length > 0 && (
        <section className="mt-20 pt-10 border-t border-slate-200/80 dark:border-slate-850">
          <h2 className="text-lg font-bold mb-6">Related Wholesale Catalog Items</h2>
